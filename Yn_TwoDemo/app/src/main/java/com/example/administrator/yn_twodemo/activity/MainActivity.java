...
public class MainActivity extends AppCompatActivity {
    ...
    private void initView() {
        pic = (ImageView) findViewById(R.id.o_pic);
        text = (TextView) findViewById(R.id.o_text);
        log = (TextView) findViewById(R.id.o_text1);
            ...
            try {
                ...
                mUserInfo.getUserInfo(new IUiListener() {
                    ...
                    public void onComplete(Object response) {
                        ...
                        String nickname = job.optString("nickname");
                        String figureurl_qq_1 = job.optString("figureurl_qq_1");
                        text.setText(nickname);
                        ImageOptions options =new ImageOptions.Builder().setCircular(true).setCrop(true).build();
                        //Picasso.with(MainActivity.this).load(figureurl_qq_1).into(pic);
